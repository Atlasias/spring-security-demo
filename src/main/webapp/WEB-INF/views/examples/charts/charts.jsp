        ...
        <div class="row mrg20">
            <div class="col-md-6 col-sm-12 col-lg-6">
                <div class="widget sales-summ pad50-40">
                    ...
                    <div class="sales-charts">
                        <div id="chrt2-1" style="height: 270px;"></div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-sm-12 col-lg-6">
                <div class="widget sales-summ pad50-40">
                    ...
                    <div class="sales-charts">
                        <div id="chrt2-2" style="height: 270px;"></div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-sm-12 col-lg-6">
            ...
            <div class="col-md-6 col-sm-12 col-lg-6">
                <div class="widget sales-summ pad50-40">
                    ...
                    <div class="sales-charts">
                        <div id="chrt2-4" style="height: 270px;"></div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="sales-charts">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="new">
                                <div id="chrt1" style="height: 270px;"></div>
                            </div>
                    ...
                    <div class="sales-charts">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="today">
                                <div id="chrt8" style="height: 270px;"></div>
                            </div>
                            <div class="tab-pane fade" id="week">
                                <div id="chrt9" style="height: 270px;"></div>
                            </div>
                            <div class="tab-pane fade" id="month">
                                <div id="chrt10" style="height: 270px;"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-7 col-sm-12 col-lg-7">
                <div class="widget tsk-prgs pad50-40">
                    <h4 class="widget-title">Task Progress</h4>
                    <div id="chart7" style="height: 270px;"></div>
                </div>
            </div>
            <div class="col-md-6 col-sm-12 col-lg-6">
                <div class="widget sales-summ pad50-40">
                    <h4 class="widget-title">Sales Difference</h4>
                    <div id="chrt4" style="height: 300px;"></div>
                </div>
            </div>
            <div class="col-md-6 col-sm-12 col-lg-6">
