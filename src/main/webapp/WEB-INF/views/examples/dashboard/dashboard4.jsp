<%@page contentType="text/html; charset=UTF-8" language="java"
	...
	<div class="option-panel">
        ...
        <div class="backgroundimg-panel">
            ...
            <span class="backgroundimg1-click" style="background-image: url(/images/resource/backgroundimg1.jpg);"></span>
            <span class="backgroundimg2-click" style="background-image: url(/images/resource/backgroundimg2.jpg);"></span>
            <span class="backgroundimg3-click" style="background-image: url(/images/resource/backgroundimg3.jpg);"></span>
            <span class="backgroundimg4-click" style="background-image: url(/images/resource/backgroundimg4.jpg);"></span>
            <span class="backgroundimg5-click" style="background-image: url(/images/resource/backgroundimg5.jpg);"></span>
        </div>
    </div>
    <!-- Options Panel -->
    <div class="pg-tp">
