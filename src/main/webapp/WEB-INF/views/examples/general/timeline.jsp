<%@page contentType="text/html; charset=UTF-8" language="java"
  ...
  <div class="pg-tp">
    ...
    <div class="pr-tp-inr">
      <h4>Timeline</h4>
      <span>Some of extra awesome Timeline style.</span>
    </div>
  </div>
  <!-- Page Top -->
      ...
      <div class="timeline-wrp">
        <div class="timeline-innr">
          <div class="timeline-label">
            <span class="brd-rd5 blue-bg">Today</span>
          </div>
          ...
          <div class="timeline-label">
            <span class="brd-rd5 dont-dstrb">2016</span>
          </div>
          <div class="timeline-block">
            <span class="pst-tm">
              <i class="ion-clock"></i> Today 2:10 pm</span>
          ...
          <div class="timeline-label">
            <a class="brd-rd5 blue-bg" href="#" title="">More Time</a>
          </div>
        </div>
      </div>
    </div>
