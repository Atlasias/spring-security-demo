...
public class SpringSecurityDemoApplication implements WebApplicationInitializer {
	...
	public void onStartup(ServletContext servletContext) throws ServletException { 
		 ...
		 * servletContext.addListener(new HttpSessionEventPublisher()); //session event
		 * publisher for embedded tomcat servletContext.addListener(new
		...
		dispatcher.setAsyncSupported(true); //this option is for spring websocket
