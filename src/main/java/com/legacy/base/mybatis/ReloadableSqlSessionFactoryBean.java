package com.legacy.base.mybatis;
...
public class ReloadableSqlSessionFactoryBean extends SqlSessionFactoryBean implements DisposableBean {
    private final Logger logger = LoggerFactory.getLogger(ReloadableSqlSessionFactoryBean.class);
            ...
            private boolean isModified() {
                ...
                if (mapperLocations != null) {
                    for (int i = 0; i < mapperLocations.length; i++) {
                        ...
                        modified |= findModifiedResource(mappingLocation);
                        if (modified) {
                            break;
                        }
                    }
